...
@implementation CLAirViewController {
...
- (void)prepareForSegue:(CLAirViewControllerSegue *)segue sender:(id)sender
{
    if ( [segue isKindOfClass:[CLAirViewControllerSegue class]] && sender == nil )
    {
        ...
        segue.performBlock = ^(CLAirViewControllerSegue* rvc_segue, UIViewController* svc, UIViewController* dvc)
        {
...
@implementation UIViewController(CLAirViewController)
...
- (CLAirViewController*)airViewController
{
    ...
    Class revealClass = [CLAirViewController class];
...
#pragma mark - CLAirViewControllerSegue Class

@implementation CLAirViewControllerSegue
